...
- v2.0 2023/12/3<br>请查看 [GitHub](https://github.com/wbmui/lh3718mui/releases/tag/v2.0) 获取详细更新日志。
...
**重要：在安装产品前，您需要提前在控制面板安装东亚语言支持。建议把非 Unicode 编码设置为中文（简体）。版本 2.0 已支持自动安装东亚语言文件。**
{:.info}
